...
coalesced_postings = pd.read_csv('coalesced_skills_by_company.csv')
...
coalesced_postings['top_skills'] = coalesced_postings['top_skills'].apply(remove_duplicates)

# Drop rows where 'filtered_skills' is empty or NaN
coalesced_postings = coalesced_postings[coalesced_postings['top_skills'].notna() & (coalesced_postings['top_skills'] != '')]
